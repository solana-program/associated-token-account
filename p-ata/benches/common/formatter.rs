...
use {
    crate::common::{BaseTestType, ComparisonResult, CompatibilityStatus, TestVariant},
...
pub fn get_all_optimizations_variant(base_test: BaseTestType) -> Option<TestVariant> {
    match base_test {
        ...
        BaseTestType::RecoverNested | BaseTestType::RecoverMultisig => Some(TestVariant::BASE),
        _ => None,
    }
}
